...
public class NestedLoopJoinNode extends PlanNode {
  private final static Logger LOG = LoggerFactory.getLogger(CustomHashJoinNode.class);
  ...
  public NestedLoopJoinNode(PlanNode outer, PlanNode inner, TableRef innerRef) {
    super("NESTED LOOP JOIN");
    innerRef_ = innerRef;
  ...
  public void computeStats(Analyzer analyzer) {
    ...
    LOG.debug("Stats NestedLoop Join: cardinality=" + Long.toString(cardinality_));
  }
